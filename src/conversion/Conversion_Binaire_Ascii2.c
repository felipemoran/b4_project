...
#include <string.h>
#include <stdlib.h>
#include "Binaire_Ascii.h"



int main()
{
    char* tab_symb = "1010101010101";
    int tab_duree[10] = {1,1,3,3,3,3,1,7,1,3,3};
...
char* conversion_binaire_ascii(char* message_binaire , int* tab_duree , int duree_impulsion, int* compteur)
{
